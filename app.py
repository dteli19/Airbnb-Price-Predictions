...
st.markdown("""
### **Overview**
This project develops a complete machine learning pipeline to predict Airbnb listing prices in Asheville, NC, using real-world data from the Inside Airbnb dataset. The workflow covers all major stages of data science — from data cleaning and exploration to feature preparation and neural network modeling. By analyzing host, property, and location attributes, the project uncovers the key factors that influence pricing and builds a baseline predictive model to estimate nightly rates accurately.
